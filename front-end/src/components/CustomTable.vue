...
function changePage(newPage) {
  ...
  api
    .post(props.tableProps.indexAPI + "?page=" + newPage, {
...
function onRequest(requestProps) {
  ...
  api
    .post(props.tableProps.indexAPI, {
